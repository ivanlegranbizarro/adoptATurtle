 ...
 <div class="md:flex">
   ...
   <div class="md:w-1/2">
     <form>
      ...
      <div>
        <label for="confirm-password" class="mb-2 block uppercase text-gray-500 font-bold">Confirm Password</label>
        <input type="password" name="confirm-password" placeholder="Confirm Your password" class="border p-3 w-full rounded-lg" />
      </div>
