...
<div class="container mx-auto mt-8">
  ...
  <form action="{{ route('adopciones.update', $adopcion->id) }}" method="POST">
    ...
    <div class="mb-4">
      ...
      <textarea name="motivation" id="motivation" rows="4" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">{{ old('motivation', $adopcion->motivation) }}</textarea>
    </div>
