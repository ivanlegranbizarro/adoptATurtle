    ...
    <turbo-frame id="turbo-frame-create">
      <form method="POST" action="{{ route('tortugas.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="name" id="name" placeholder="Turtle name" value="{{ old('name') }}"
            class="border p-3 w-full rounded-lg" required minlength="2" />
          @error('name')
        ...
        <div class="mb-4">
          ...
          <input type="date" name="birthday" id="birthday" placeholder="Turtle's birthday" value="{{ old('birthday') }}"
        ...
        <input type="submit" value="Create Turtle"
